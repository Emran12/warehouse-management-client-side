  ...
  return (
    <div>
      <div className="container mt-5">
        ...
        <p>
          <ol>
            ...
            <li>
              ...
              web application. Activity can be addressing business validation or
              ...
              create or executing shell script, or getting some specific
              hardware related information on one call or installed certificate
              details in the system or lot of define task which are non-blocking
            ...
            <li>
              ...
              the same time, we can say it following Java Programming language
              standard. Whereas node JS is written in C++, and provide V8 engine
              base browser javascript running engine which helps us to run
              written javascript program in any browser environment.
            </li>
            <li>
              ...
              binding with the file system, and also allowing developer for
              reading or sometimes write on disk.
            </li>
          </ol>
        </p>
        ...
        <p>
          NoSQL databases typically have very flexible schemas. A flexible
          schema allows you to easily make changes to your database as
          ...
          faster.On the other hadn, SQL databases have fixed or static or
          predefined schema.
        </p>
        <p>
          NoSQL databases allow you to scale-out horizontally, meaning you can
          add cheaper, commodity servers whenever you need to.Conversely,Most
          SQL databases require you to scale-up vertically (migrate to a larger,
          more expensive server) when you exceed the capacity requirements of
          your current server.
        </p>
        <p>
          NoSQL databases is typically stored in a way that is optimized for
          queries. The rule of thumb when you use MongoDB is Data that is
          accessed together should be stored together. Queries typically do not
          require joins, so the queries are very fast.However, Data in SQL
          databases is typically normalized, so queries for a single object or
          entity require you to join data from multiple tables. As your tables
          grow in size, the joins can become expensive.
        </p>
        <p>
        ...
        <p>
          ...
          RSA or ECDSA.The purpose of using JWT is not to hide data but to
          ensure the authenticity of the data. JWT is signed and encoded, not
          encrypted. JWT is a token based stateless authentication mechanism.
          Since it is a client-side based stateless session, server doesn’t have
          to completely rely on a datastore(database) to save session
          information.
        </p>
        <h3 className="text-info">How does JWT work</h3>
        <p>
          JSON Web Tokens consist of three parts separated by dots (.), which
          are: Header, Payload, Signature.
          <img src={jwtImg} alt="" />
          <br></br>
          ...
          HMAC SHA256 or RSA.<br></br>
          Payload: The second part of the token is the payload, which contains
          the claims. Claims are statements about an entity (typically, the
          user) and additional data. There are three types of claims:
          registered, public, and private claims. <br></br>
